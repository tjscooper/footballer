  ...
  */
  ...
  static _parseGame(game) {
    ...
    return new Game({
      ...
      quarter: game.score.phase,
      redZone: game.score.redZone,
      gameClock: game.score.time,
      down: game.score.down,
      yardsToGo: game.score.yardsToGo,
      yardline: game.score.yardline ? game.score.yardline.toString() : "",
      yardlineSide: game.score.yardlineSide ? game.score.yardlineSide.toString() : "",
      yardlineNumber: game.score.yardlineNumber ? game.score.yardlineNumber.toString() : "",
      possessionTeamId: game.score.possessionTeamId,
      possessionTeamAbbr: game.score.possessionTeamAbbr,
      alertPlayType: game.score.alertPlayType ? game.score.alertPlayType.toString() : "",
      home: homeTeam,
      visitor: visitorTeam,
      winner,
      spread
