    ...
    return (
      <div className="row">
        <div className="column">
          <button
            className={ classnames('ui basic button', { 'positive' : game.home.city === game.pick.city }) }
        ...
        <div className="column">
          <button
            className={ classnames('ui basic button', { 'positive' : game.visitor.city === game.pick.city }) }
